...
function newGame(){setUpPanel();for(var b=sessionStorage.numRows,a=sessionStorage.numCols,d=0;d<b;d++)for(var c=0;c<a;c++){sessionStorage["cell"+d+""+c+"value"]="";sessionStorage["cell"+d+""+c+"state"]=""}$.getJSON("/getminedata",function(f){var e=$("#text");e.html("<table>");for(var h=0;h<b;h++){e.append("<tr>");for(var g=0;g<a;g++){$("#text").append("<td>("+h+","+g+")<br />"+f.locations[h][g].value+"</td>");sessionStorage["cell"+h+""+g+"value"]=f.locations[h][g].value;sessionStorage["cell"+h+""+
