...
function generateBoard(e,d){for(var c={locations:[]},a=0;a<d;a++){c.locations[a]=[];for(var b=0;b<e;b++)c.locations[a][b]={},c.locations[a][b].value=0}b=[];for(a=0;a<9;a++){b[a]={};do b[a].x=Math.floor(Math.random()*d),b[a].y=Math.floor(Math.random()*e);while(c.locations[b[a].x][b[a].y].value!=="MINE");c.locations[b[a].x][b[a].y].value="MINE";b[a].x-1>=0&&(c.locations[b[a].x-1][b[a].y].value!=="MINE"&&c.locations[b[a].x-1][b[a].y].value++,b[a].y-1>=0&&c.locations[b[a].x-1][b[a].y-1].value!=="MINE"&&
c.locations[b[a].x-1][b[a].y-1].value++,b[a].y+1<e&&c.locations[b[a].x-1][b[a].y+1].value!=="MINE"&&c.locations[b[a].x-1][b[a].y+1].value++);b[a].y-1>=0&&c.locations[b[a].x][b[a].y-1].value!=="MINE"&&c.locations[b[a].x][b[a].y-1].value++;b[a].y+1<e&&c.locations[b[a].x][b[a].y+1].value!=="MINE"&&c.locations[b[a].x][b[a].y+1].value++;b[a].x+1<d&&(c.locations[b[a].x+1][b[a].y].value!=="MINE"&&c.locations[b[a].x+1][b[a].y].value++,b[a].y-1>=0&&c.locations[b[a].x+1][b[a].y-1].value!=="MINE"&&c.locations[b[a].x+
1][b[a].y-1].value++,b[a].y+1<e&&c.locations[b[a].x+1][b[a].y+1].value!=="MINE"&&c.locations[b[a].x+1][b[a].y+1].value++)}return c}window.onunload=function(){sessionStorage.gameState="p"};